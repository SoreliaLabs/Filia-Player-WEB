...
(() => {
  ...
  const UNSPLASH_HOMEPAGE_HREF =
    'https://unsplash.com/?utm_source=sorelia_labs&utm_medium=referral';
  ...
  const withReferral = (href) => {
    try {
      ...
      if (!u.searchParams.has('utm_source')) {
        u.searchParams.set('utm_source', 'sorelia_labs');
      }
  ...
  class ImageSlot extends HTMLElement {
    ...
    _render() {
      ...
      // (viene escrito en el HTML) so it passes through unchanged.
